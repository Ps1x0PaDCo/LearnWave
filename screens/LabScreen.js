...
const styles = StyleSheet.create({
  ...
  introCard: { flexDirection: 'row', alignItems: 'flex-start', borderWidth: 1, borderRadius: 22, padding: 14, marginBottom: 18, overflow: 'hidden' },
  introIcon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  introTitle: { fontSize: 15, fontWeight: '900', marginBottom: 5 },
  introText: { fontSize: 13, lineHeight: 19, fontWeight: '600' },
